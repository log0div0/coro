...
BOOST_AUTO_TEST_CASE(TestRead) {
	Buffer buffer(1000, std::vector<uint8_t> {0x7e, 0x08, 0x40, 0x8b, 0x00, 0x0b});
...
BOOST_AUTO_TEST_CASE(TestWrite) {
	...
	BOOST_REQUIRE(buffer == Buffer(1000, std::vector<uint8_t> {0x7e, 0x08, 0x40}));
	WriteWsPayloadLength(buffer, 0);
	BOOST_REQUIRE(buffer == Buffer(1000, std::vector<uint8_t> {0x00, 0x7e, 0x08, 0x40}));
	WriteWsPayloadLength(buffer, 11);
	BOOST_REQUIRE(buffer == Buffer(1000, std::vector<uint8_t> {0x0b, 0x00, 0x7e, 0x08, 0x40}));
}
